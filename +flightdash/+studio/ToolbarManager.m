classdef ToolbarManager < handle
    ...
    methods (Access = private)
        function build(obj, parentGrid)
            ...
            grid = uigridlayout(obj.Panel, [1 27], 'RowHeight', {'1x'}, ...
            ...
            grid.ColumnWidth = { ...
                ...
                buttonW, buttonW};                      % Explorer / RightDock toggles
            ...
            obj.Buttons.RightDock  = obj.addButton(grid, 'RDock',   'Toolbar:ToggleRightDock');
        end
