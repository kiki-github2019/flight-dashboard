    ...
    methods (Static, Access = private)
        ...
        function s = sessionToStruct(sess)
            s = struct( ...
                ...
                'OptionFilePath', {sess.OptionFilePath}, ...
        ...
        function sess = structToSession(s)
            ...
            % Phase A: OptionFilePath round-trip. Older archives without
            % the field load with the SessionModel default ({'', ''}).
            sess.OptionFilePath = flightdash.project.ProjectSerializer.fieldCellPair(s, 'OptionFilePath');
