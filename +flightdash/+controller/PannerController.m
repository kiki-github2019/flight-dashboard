    ...
    methods
        ...
        function togglePanner(obj, fIdx)
            ...
            try
                ...
                obj.Adapter.logCaught(ME, 'Panner:toggle');
            end
        end
        ...
        function onPannerClicked(obj, fIdx)
            ...
            try
                ...
                obj.Adapter.logCaught(ME, 'Panner:clicked');
            end
        end
        ...
        function startHandleDrag(obj, fIdx, side, event)
            ...
            try
                ...
                obj.Adapter.logCaught(ME, 'PannerHandle:start');
            end
        end
        ...
        function handleDragMotion(obj)
            ...
            try
                ...
                obj.Adapter.logCaught(ME, 'PannerHandle:motion');
            end
        end
        ...
        function stopHandleDrag(obj)
            try
                ...
                obj.DragFIdx = 0;
                obj.DragSide = '';
                if ~obj.Adapter.isValidApp(), return; end
                ...
                obj.Adapter.logCaught(ME, 'PannerHandle:stop');
            end
        end
        ...
        function tf = bindFigureCallbacks(obj)
            ...
            if obj.Adapter.isEmbedded()
                ...
                try
                    ...
                    obj.Adapter.logCaught(ME, 'Panner:router');
                catch
                end
                return;
            end
            ...
            fig.WindowButtonMotionFcn = @(~,~) obj.handleDragMotion();
            fig.WindowButtonUpFcn    = @(~,~) obj.stopHandleDrag();
            tf = true;
        end
        ...
        function onRangeChanged(obj, fIdx)
            ...
            try
                ...
                obj.Adapter.logCaught(ME, 'Panner:range');
            end
        end
        ...
        function resetRange(obj, fIdx)
            ...
            try
                ...
                obj.Adapter.logCaught(ME, 'Panner:reset');
            end
        end
        ...
        function setCurrentTabXLim(obj, fIdx, fromVal, toVal)
            ...
            try
                ...
                obj.Adapter.logCaught(ME, 'Panner:setXLim');
            end
        end
        ...
        function resetProgrammaticXLim(obj, fIdx)
            ...
            try
                ...
                obj.Adapter.logCaught(ME, 'Panner:resetProgrammaticXLim');
            end
        end
